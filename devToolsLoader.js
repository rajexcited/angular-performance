...
chrome.runtime.onConnect.addListener(function(port) {
  ...
  if (port.name === 'devtools-page'){
	...
	var aa=port.onMessage.addListener(function(msg) {
		console.log(msg);
		//port.postMessage({counter: msg.counter+1});
	});
	console.log(aa);
	
    // Removes the msg listener on disconnection and cleans up connections
	...
	console.log('Background Unknown port');
  }
